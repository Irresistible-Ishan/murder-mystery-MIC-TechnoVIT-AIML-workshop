...
final murder scene:
chat0 was found dead right inside the washroom with his head very hardly bursted on the wall , the amount of force seems like he may have slipped but at same time the floor was dry 
...
"""
  ...
  if not choice in characters:
    print("\nplease write the name of the character correctly as per the menu :)")
  else:
    tries[choice][0] += 1
    if choice == "chat1":
      reply  = chat1.send_message("The detective is interrogating you , here is the question : "+input("Ask a question : ")).text
      print(f"\n{choice} says : {reply}\n")
      tries[choice][1].append(reply)
    elif choice == "chat2":
      reply  = chat2.send_message("The detective is interrogating you , here is the question : "+input("Ask a question : ")).text
      print(f"\n{choice} says : {reply}\n")
      tries[choice][1].append(reply)
    elif choice == "chat3":
      reply  = chat3.send_message("The detective is interrogating you , here is the question : "+input("Ask a question : ")).text
      print(f"\n{choice} says : {reply}\n")
      tries[choice][1].append(reply)
    elif choice == "chat4":
      reply  = chat4.send_message("The detective is interrogating you , here is the question : "+input("Ask a question : ")).text
      print(f"\n{choice} says : {reply}\n")
      tries[choice][1].append(reply)
